...
class Lexer:
    ...
    def make_identifier(self):
        ...
        # Handle multi-word keywords like 'nahole jodi' or 'othoba jodi'
        if id_str in ("nahole", "othoba"):
            # save position
            save_idx = self.pos.idx
            save_ln = self.pos.ln
            save_col = self.pos.col
            ...
            if next_word == 'jodi':
                id_str = id_str + ' ' + next_word
            else:
                # rollback if not matched
                # reposition pos and current_char
                self.pos.idx = save_idx
                self.pos.ln = save_ln
                self.pos.col = save_col
                self.current_char = self.text[self.pos.idx] if self.pos.idx < len(
                    self.text) else None
